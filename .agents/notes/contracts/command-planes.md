...
| `spark-web` | `spark web` | DSH web profile boot | installed DSH web profile, Cue/LLM plugins, provider onboarding | Hub UI, daemon execution, or `web_search`/`fetch_content` |
