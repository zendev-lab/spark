...
import type { SparkModeMessageApi } from "../packages/spark-extension/src/extension/spark-mode-entry.ts";
...
import { createSparkAgentEndReconciliationController } from "../packages/spark-extension/src/extension/spark-agent-end-reconciliation.ts";
