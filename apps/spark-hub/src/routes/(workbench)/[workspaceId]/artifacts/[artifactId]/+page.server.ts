...
import type { ArtifactPreviewStatus } from "@zendev-lab/spark-hub-coordination/artifact-cache";
...
export const load = (({ params }) => {
  ...
  return {
    ...
    links: page.links,
    memoryProposal: parseHubMemoryProposalDetail(contentRef),
    memoryQuarantine: parseHubMemoryQuarantineDetail(contentRef),
    preview,
