          ...
          payload: {
            command: {
              ...
              payload: {
                kind: "task.start.request",
                title: "Agents",
                payload: { source: agentsHubSource, prompt: "hello" },
              },
              status: "queued",
              deliveryStatus: "pending",
          ...
          payload: {
            command: {
              ...
              payload: {
                kind: "task.start.request",
                title: "Real",
                payload: { source: agentsHubSource, prompt: "hello optimistic" },
              },
              status: "queued",
              deliveryStatus: "pending",
            },
      ...
      commands: [
        {
          ...
          payloadJson: JSON.stringify({
            payload: { source: agentsHubSource, runtimeTaskId: "task_live" },
          }),
          status: "acked",
