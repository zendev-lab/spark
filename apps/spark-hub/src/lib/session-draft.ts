...
const sessionDraftPrefix = "spark-hub.session-draft.v1";
const sessionPendingSubmissionPrefix = "spark-hub.session-submit.v1";
const startConversationPendingSubmissionPrefix = "spark-hub.start-submit.v1";
