...
vi.mock("@zendev-lab/spark-hub-coordination/runtime-registration", async (importOriginal) => {
  const actual =
    await importOriginal<
      typeof import("@zendev-lab/spark-hub-coordination/runtime-registration")
    >();
  return {
    ...actual,
