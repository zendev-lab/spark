...
import { RuntimeWorkspaceLeaseConflictError } from "@zendev-lab/spark-hub-coordination/runtime-registration";
...
vi.mock("@zendev-lab/spark-hub-coordination/runtime-registration", async () => ({
