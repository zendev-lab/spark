...
export function mergeMessagePlatformCredentials(
  ...
  const next: HubChannelEditorValues = {
    ...previous,
    ingressEnabled: true,
    onUnbound: "create",
  };
...
export function channelEditorCredentialsComplete(values: HubChannelEditorValues): boolean {
...
export function channelsConfigFromEditorValues(values: HubChannelEditorValues): ChannelsConfig {
