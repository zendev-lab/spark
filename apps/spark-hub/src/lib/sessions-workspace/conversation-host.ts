...
export type SessionConversationHost = {
  ...
  get sessionDirectiveForm(): HTMLFormElement | null;
  set sessionDirectiveForm(value: HTMLFormElement | null);
  ...
  sessionSlashSuggestions: readonly HubSlashCommandSuggestion[];
