...
import { hubComposerFeedbackAfterInput } from "$lib/slash-actions";
...
export function createComposerController(sources: ComposerSources) {
  ...
  function handleStartMessageChange(value: string) {
    ...
    const transition = hubComposerFeedbackAfterInput(startState);
  ...
  function handleSessionMessageChange(value: string) {
    ...
    const transition = hubComposerFeedbackAfterInput(sendState);
