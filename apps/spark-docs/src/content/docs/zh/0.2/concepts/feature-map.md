...
slug: zh/0.2/concepts/feature-map
---
...
支持的产品。详情见[界面与所有权](/zh/0.2/concepts/surfaces/)和
[CLI 参考](/zh/0.2/reference/cli/)。
...
attach、resume 和取消操作见[运行与会话](/zh/0.2/guides/runs-and-sessions/)。

## 2. 交互式设计：Cockpit 与 TUI

* [TUI](/zh/0.2/guides/tui/) 适合本地快速对话、Plan/Implement、引导当前运行、
  选择模型和查看当前会话。
* [Cockpit](/zh/0.2/guides/cockpit/) 适合工作空间概览、对话、收件箱、产品产物、
  资源和跨 daemon 监督。
...
完整且区分 profile 的清单见 [Agent 工具参考](/zh/0.2/reference/tools/)。
...
先读[规划并实现一个修改](/zh/0.2/guides/plan-and-implement/)，需要长期工作时再读
[长期自动推进](/zh/0.2/guides/automation/)。
...
详情见[协作与渠道](/zh/0.2/guides/collaboration/)和
[Side Threads](/zh/0.2/guides/side-threads/)。
...
修改运行时存储前先看[配置与路径](/zh/0.2/reference/configuration-and-paths/)；
界面与 daemon 状态不一致时看[故障排查](/zh/0.2/troubleshooting/)。
