...
hero:
  ...
  actions:
    - text: 快速开始
      link: /zh/0.2/getting-started/
      icon: right-arrow
    - text: CLI 参考
      link: /zh/0.2/reference/cli/
      icon: right-arrow
      variant: minimal
sidebar:
  order: 1
...
先阅读[安装与首次运行](/zh/0.2/getting-started/)，然后
[规划并实现一个修改](/zh/0.2/guides/plan-and-implement/)。想了解 CLI、daemon、TUI、
Cockpit、工具、自动推进和协作如何组合时，查看[完整功能地图](/zh/0.2/concepts/feature-map/)。
只有需要远程运维或诊断系统时，才需要理解[界面与所有权](/zh/0.2/concepts/surfaces/)。
