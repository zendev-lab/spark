...
description: Understand the CLI dispatcher, TUI, daemon, and Cockpit without
  creating competing sources of truth.
slug: 0.2/concepts/surfaces
---
...
roots. See [configuration and paths](/0.2/reference/configuration-and-paths/).
