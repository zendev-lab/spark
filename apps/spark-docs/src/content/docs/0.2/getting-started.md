...
description: Install Spark, configure a model, and complete a first foreground
  or interactive run.
sidebar:
  order: 2
slug: 0.2/getting-started
---
...
* Follow the [operator handbook](/0.2/guides/operator-handbook/) for the complete
  daemon, Cockpit, workspace, session, and durable execution path.
* [Plan and implement your first change](/0.2/guides/plan-and-implement/).
* Browse the [complete feature map](/0.2/concepts/feature-map/) without learning every command.
* Learn the [TUI's progressive controls](/0.2/guides/tui/).
* Choose between [foreground runs, background work, and sessions](/0.2/guides/runs-and-sessions/).
* Open the [Cockpit web surface](/0.2/guides/cockpit/).
* Use [automation](/0.2/guides/automation/) only when ordinary Plan and Implement are not enough.
