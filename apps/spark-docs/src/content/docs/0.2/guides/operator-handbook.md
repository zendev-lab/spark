...
description: Run Spark end to end, connect Cockpit, create sessions, inspect
  invocations, and recover safely.
slug: 0.2/guides/operator-handbook
---
...
Continue with [TUI](/0.2/guides/tui/), [runs and sessions](/0.2/guides/runs-and-sessions/),
[Cockpit](/0.2/guides/cockpit/), and [long-running work](/0.2/guides/automation/).
