...
description: Distinguish roles, sessions, Side Threads, and message-platform
  channels before coordinating work.
slug: 0.2/guides/collaboration
---
...
[Side Thread](/0.2/guides/side-threads/) for a bounded read-only tangent.
