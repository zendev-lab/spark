...
description: Turn a goal into verifiable tasks, implement the approved plan, and
  inspect the result.
slug: 0.2/guides/plan-and-implement
---
...
* Use [`spark run`](/0.2/guides/runs-and-sessions/) for one foreground result.
* Use [`spark bg`](/0.2/guides/runs-and-sessions/) when the shell should return immediately.
* Use [automation](/0.2/guides/automation/) for a durable goal, repeated work,
