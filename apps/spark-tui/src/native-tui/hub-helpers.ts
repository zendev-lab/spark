...
export function isSparkNativeHubPanel(value: string): value is SparkNativeHubPanel {
  return (SPARK_HUB_PANELS as readonly string[]).includes(value);
}
...
export function compareRunsForHub(left: SparkRunView, right: SparkRunView): number {
