...
test("Spark product policy role-run surfaces are no-op safe without UI", async () => {
...
test("Spark product policy publishes role-run footer status, below-editor widget, and completion message", async () => {
