...
lane summaries come from the persisted v9 Repro record and join TaskRun history
from TaskGraph by TaskRef; Goal readiness comes from the selected TaskGraph
project plus daemon-owned pending human requests.
