...
async function main() {
  ...
  if (sourceMirrorCount > 0) {
    ...
    console.error(
      "Replace repository-source fragment assertions with observable behavior. Put architecture, workflow, package, and documentation policy in a dedicated static checker; this gate has no compatibility baseline.",
    );
  }
