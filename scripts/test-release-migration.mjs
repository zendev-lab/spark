...
function phaseEnvironment(baseEnv, root) {
  ...
  const inheritedPaths =
    "SPARK_BUILD_INFO_PATH SPARK_COCKPIT_SERVER_ENTRYPOINT SPARK_COCKPIT_WEB_SERVICE_ENTRYPOINT SPARK_DAEMON_ENTRYPOINT SPARK_DEPLOYMENT_WATCH_PATH SPARK_HEADLESS_EXECUTOR_MODULE SPARK_MANAGED_CACHE_DIR SPARK_MANAGED_CONFIG_FILE SPARK_MANAGED_STATE_DIR SPARK_MANAGED_VERSIONS_DIR SPARK_PRODUCT_DIST SPARK_STABLE_LAUNCHER";
