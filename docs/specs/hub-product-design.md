# Hub product design contract

Hub is a projection and control adapter for inspectable work. It does not
...
- The daemon owns execution truth. Hub consumes `SparkSessionView.work` and
