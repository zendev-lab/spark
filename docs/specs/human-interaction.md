...
Driver activation and reactivation require a human authorization event. A
read-only status or recovery path cannot mint new authority or restart an
explicitly stopped driver.
