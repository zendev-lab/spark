...
1. On the Cockpit host, mint a Cockpit browser key: `spark hub access create`. Open `/login` and exchange it for Cockpit session cookies (`spark_cockpit_session` + rotating refresh).
