...
export const sparkCommandKindOptions = [
  ...
  "daemon.access.create.request",
  "daemon.access.list.request",
  "daemon.access.revoke.request",
  "daemon.access.verify.request",
  "turn.submit.request",
  "turn.cancel.request",
  "turn.status.request",
  "turn.result.request",
  ...
  "invocation.retention.apply.request",
  "usage.summary.request",
  "repro.start.request",
  "repro.status.request",
  "repro.stop.request",
  "loop.start.request",
  "loop.status.request",
  "loop.stop.request",
  "loop.restart.request",
  "loop.wake.request",
  ...
  "workspace.resolve_session_cwd.request",
  "workspace.attach.request",
  "workspace.stop.request",
  "workspace.lifecycle.request",
...
export const localRpcMethodToSparkCommandKind = {
  ...
  "daemon.access.create": "daemon.access.create.request",
  "daemon.access.list": "daemon.access.list.request",
  "daemon.access.revoke": "daemon.access.revoke.request",
  "daemon.access.verify": "daemon.access.verify.request",
  ...
  "invocation.retention.apply": "invocation.retention.apply.request",
  "usage.summary": "usage.summary.request",
  "repro.start": "repro.start.request",
  "repro.status": "repro.status.request",
  "repro.stop": "repro.stop.request",
  "loop.start": "loop.start.request",
  "loop.status": "loop.status.request",
  "loop.stop": "loop.stop.request",
  "loop.restart": "loop.restart.request",
  "loop.wake": "loop.wake.request",
  "loop.schedule": "loop.schedule.request",
  ...
  "workspace.resolve-session-cwd": "workspace.resolve_session_cwd.request",
  "workspace.attach": "workspace.attach.request",
  "workspace.stop": "workspace.stop.request",
  "workspace.lifecycle": "workspace.lifecycle.request",
  ...
  "session.retry-target": "session.snapshot.request",
  "session.create": "session.create.request",
  "session.spawn": "session.spawn.request",
  ...
  "session.close": "session.close.request",
  "session.compact": "session.compact.request",
  ...
  "model.enabled.set": "model.enabled.set.request",
  "provider.auth.api-key.set": "provider.auth.api_key.set.request",
  "provider.auth.import.pi": "provider.auth.import.pi.request",
  ...
  "role.model.list": "role.model.request",
  "role.model.get": "role.model.request",
  "role.model.set": "role.model.request",
  "role.model.delete": "role.model.request",
...
export const runtimeServerCommandSpecifications = {
  ...
  "session.media.read.request": sessionCommand("read"),
  "session.create.request": sessionCommand("mutation"),
  "session.spawn.request": sessionCommand("mutation"),
  "session.fork.request": sessionCommand("mutation"),
  ...
  "session.close.request": sessionCommand("mutation"),
  ...
  "invocation.list.request": daemonReadCommand(),
  ...
  "model.connectivity.test.request": daemonMutationCommand(),
  "model.default.set.request": daemonMutationCommand(),
  "model.enabled.set.request": daemonMutationCommand(),
  "provider.auth.import.pi.request": daemonMutationCommand(),
  ...
  "channel.status.request": daemonReadCommand(),
  "channel.reload.request": daemonMutationCommand(),
  "channel.qqbot.auth.start.request": daemonMutationCommand(),
  "channel.qqbot.auth.status.request": daemonReadCommand(),
  "channel.qqbot.auth.cancel.request": daemonMutationCommand(),
