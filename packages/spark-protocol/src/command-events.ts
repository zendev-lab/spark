...
export const sparkCommandKindOptions = [
  ...
  "driver.stop.request",
  "driver.restart.request",
  "driver.wake.request",
  "driver.schedule.request",
...
export const localRpcMethodToSparkCommandKind = {
  ...
  "driver.start": "driver.start.request",
  "driver.status": "driver.status.request",
  "driver.stop": "driver.stop.request",
  "driver.restart": "driver.restart.request",
  "driver.wake": "driver.wake.request",
  "driver.schedule": "driver.schedule.request",
