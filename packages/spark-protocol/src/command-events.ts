...
export const sparkCommandKindOptions = [
  ...
  "usage.persistence.request",
  "usage.backfill.request",
  "repro.formal_evidence.record.request",
  "loop.start.request",
  "loop.status.request",
  "loop.stop.request",
...
export const localRpcMethodToSparkCommandKind = {
  ...
  "usage.persistence": "usage.persistence.request",
  "usage.backfill": "usage.backfill.request",
  "repro.formal-evidence.record": "repro.formal_evidence.record.request",
  ...
  "loop.control": "loop.control.request",
...
export const runtimeServerCommandSpecifications = {
  ...
  "loop.control.request": sessionCommand("mutation"),
  ...
  "channel.qqbot.auth.start.request": workspaceMutationCommand(),
  "channel.qqbot.auth.status.request": workspaceReadCommand(),
  "channel.qqbot.auth.cancel.request": workspaceMutationCommand(),
