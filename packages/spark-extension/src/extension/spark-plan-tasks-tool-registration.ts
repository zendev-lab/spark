      ...
      tasks: Type.Array(
        Type.Object({
          ...
          roleRef: Type.Optional(
            Type.String({
              description:
                "Optional builtin/extension/project/user Spark RoleSpec id or ref, e.g. explorer, reviewer, or executor. This is a preferred executor hint, not a readiness requirement.",
            }),
          ),
