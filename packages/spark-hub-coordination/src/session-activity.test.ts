...
describe("session activity projection", () => {
  ...
  it("reloads task, artifact, and interaction view state from daemon events", () => {
    ...
    appendEvent(db, {
      ...
      payload: {
        ...
        view: {
          type: "artifact.update",
          artifact: {
            ref: "artifact:reload-preview",
            title: "Reload preview",
            kind: "preview",
            format: "mdx",
            status: "ready",
            producer: "spark-runtime",
            preview: "The product preview remains in the product lane.",
          },
        },
      },
      createdAt: "2026-07-09T00:07:30.000Z",
    });
    appendEvent(db, {
      workspaceId: workspace.id,
      actorKind: "runtime",
    ...
    expect(activity.reports).toEqual([
      ...
      {
        id: "artifact:reload-preview",
        kind: "artifact.update",
        title: "Reload preview",
        text: "The product preview remains in the product lane.",
        role: "spark-runtime",
        status: "ready",
        createdAt: "2026-07-09T00:07:30.000Z",
