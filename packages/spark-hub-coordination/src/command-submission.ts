/**
 * Hub command submission — projection outbox that delivers via spark-protocol envelopes.
 *
 * Daemon/runtime remains the canonical execution owner. Hub persists queued commands
