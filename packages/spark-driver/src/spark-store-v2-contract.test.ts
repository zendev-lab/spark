...
import { rebuildSessionIndex, sessionDirectoryNameForKey } from "./index.ts";

type JsonObject = Record<string, unknown>;

const fixtureDir = join(dirname(fileURLToPath(import.meta.url)), "__fixtures__", "spark-store-v2");
