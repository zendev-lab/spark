const messages = {
  ...
  sessions: {
    ...
    sideThread: {
      title: "Side Thread",
      description:
        "A daemon-owned, isolated investigation attached to this conversation. Cockpit forwards the same control commands as the native TUI.",
  ...
  artifactDetail: {
    ...
    sparkUi: {
      ...
      title: "Legacy Spark UI replay",
      body: "This existing artifact uses the retired spark.ui.v1 contract. Cockpit keeps a read-only source/AST adapter and never executes MDX, JavaScript, or raw HTML; new documents use Markdown, safe MDX-lite, HTML, or A2UI.",
  ...
  settings: {
    ...
    access: {
      ...
      body: "Mint one-time Cockpit keys for remote browsers. Keys exchange at /login and are not tied to a workspace.",
      createHeading: "Issue a Cockpit key",
      createBody: "Each key authenticates one browser to the Cockpit control plane.",
      label: "Access label (optional)",
      labelPlaceholder: "Teammate access",
      createToken: "Generate one-time key",
      tokenCreatedTitle: "Cockpit key ready — shown once",
      tokenCreatedHint:
      ...
      defaultTokenLabel: "Cockpit browser access",
      revoke: "Revoke",
    },
    metrics: {
