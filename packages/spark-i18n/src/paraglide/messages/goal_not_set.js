...
*/
export const goal_not_set = /** @type {((inputs?: Goal_Not_SetInputs, options?: { locale?: "en" | "zh-CN" }) => LocalizedString) & import('../runtime.js').MessageMetadata<Goal_Not_SetInputs, { locale?: "en" | "zh-CN" }, {}>} */ ((inputs = {}, options = {}) => {
	const locale = experimentalStaticLocale ?? options.locale ?? getLocale()
	if (locale === "zh-CN") return zh_cn2_goal_not_set(inputs)
	return en_goal_not_set(inputs)
});
