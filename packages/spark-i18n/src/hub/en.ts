const messages = {
  ...
  home: {
    ...
    workspaceHome: {
      ...
      removeConfirmBody:
        "This removes “{name}” from the Hub directory and disconnects its daemon binding. Local directories and sessions on the machine are kept; you can create and connect again later.",
  ...
  sessions: {
    ...
    daemonUnavailableTitle: "Workspace daemon is offline",
    daemonUnavailableBody:
      "Cached conversations remain available. Reconnect the workspace daemon to create, archive, or send messages.",
